...
const DashboardPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // 1. 자정 초기화 로직 추가
        const lastVisitDate = localStorage.getItem('lastDashboardVisitDate');
        ...
        if (lastVisitDate !== today) {
          ...
          localStorage.setItem('lastDashboardVisitDate', today);
          console.log('Dashboard stats reset due to new day.');
        }
